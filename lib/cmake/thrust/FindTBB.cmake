...
if (WIN32 AND MSVC)
  ...
  elseif (MSVC_VERSION GREATER_EQUAL 1900 AND MSVC_VERSION LESS_EQUAL 1959)
    # 1900-1959 spans multiple Visual Studio versions:
    ...
    # 1930-1949 = VS 17.x (v143/v144 toolsets) a.k.a. MSVC 2022
    # 1950-1959 = VS 18.0 (v145 toolset) a.k.a. MSVC 2026
    #
